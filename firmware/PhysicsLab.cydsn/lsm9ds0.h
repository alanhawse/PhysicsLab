...
#define LSM9DS0SlaveAccel SPI_SPI_SLAVE_SELECT0
#define LSM9DS0SlaveGyro SPI_SPI_SLAVE_SELECT1
#define LSM9DS0SlaveMag SPI_SPI_SLAVE_SELECT0
...
void LSM9DS0enableReadings(void);
inline int LSM9DS0isBroken(void);
int LSM9DS0test(void);
	...
	typedef enum LSM9DS0accel_scale
	{
		A_SCALE_2G,	// 000:  2g
		A_SCALE_4G,	// 001:  4g
		A_SCALE_6G,	// 010:  6g
