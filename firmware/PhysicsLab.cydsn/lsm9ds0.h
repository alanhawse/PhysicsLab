...
#define LSM9DS0_INT1HS_XH_G		0x32
#define LSM9DS0_INT1HS_XL_G		0x33
#define LSM9DS0_INT1HS_YH_G		0x34
#define LSM9DS0_INT1HS_YL_G		0x35
#define LSM9DS0_INT1HS_ZH_G		0x36
#define LSM9DS0_INT1HS_ZL_G		0x37
#define LSM9DS0_INT1_DURATION_G		0x38

//////////////////////////////////////////
// LSM9DS0 Accel/Magneto (XM) Registers //
//////////////////////////////////////////
#define LSM9DS0_OUTEMP_L_XM		0x05
#define LSM9DS0_OUTEMP_H_XM		0x06
...
#define LSM9DS0_INTHS_L_M			0x14
#define LSM9DS0_INTHS_H_M			0x15
...
#define LSM9DS0_INT_GEN_1HS		0x32
#define LSM9DS0_INT_GEN_1_DURATION	0x33
#define LSM9DS0_INT_GEN_2_REG		0x34
#define LSM9DS0_INT_GEN_2_SRC		0x35
#define LSM9DS0_INT_GEN_2HS		0x36
#define LSM9DS0_INT_GEN_2_DURATION	0x37
#define LSM9DS0_CLICK_CFG			0x38
#define LSM9DS0_CLICK_SRC			0x39
#define LSM9DS0_CLICKHS			0x3A
#define LSM9DS0IME_LIMIT			0x3B
#define LSM9DS0IME_LATENCY		0x3C
#define LSM9DS0IME_WINDOW			0x3D
#define LSM9DS0_ACTHS				0x3E
...
#define LSM9DS0TESTSPIFLAG (1<<0)
#define LSM9DS0TESTXMFLAG (1<<1)
#define LSM9DS0TESTGFLAG (1<<2)

int LSM9DS0isBroken(void);
int LSM9DS0test(void);


	// gyro_scale defines the possible full-scale ranges of the gyroscope:
	typedef enum LSM9DS0Gyro_scale
	{
	...
	typedef enum LSM9DS0_accel_scale
	{
		A_SCALE_2G,	// 000:  2g
		A_SCALE_4G,	// 001:  4g
		A_SCALE_6G,	// 010:  6g
	...
	typedef enum LSM9DS0_mag_scale
	{
		M_SCALE_2GS,	// 00:  2Gs
		M_SCALE_4GS, 	// 01:  4Gs
		M_SCALE_8GS,	// 10:  8Gs
	...
	typedef enum LSM9DS0_accel_odr
	{
	...
	typedef enum LSM9DS0_accel_abw
	{
	...
	//LSM9DS0(interface_mode interface, uint8 gAddr, uint8 xmAddr);
	...
	/* uint16 LSM9DS0_begin(LSM9DS0Gyro.yro_scale gScl = G_SCALE_245DPS, 
				LSM9DS0_accel_scale aScl = A_SCALE_2G, LSM9DS0_mag_scale mScl = M_SCALE_2GS,
				LSM9DS0Gyro.yro_odr gODR = G_ODR_95_BW_125, LSM9DS0_accel_odr aODR = A_ODR_50, 
				LSM9DS0_mag_odr mODR = M_ODR_50);
    */
    
    uint16 LSM9DS0_begin(LSM9DS0Gyro_scale gScl , 
				LSM9DS0_accel_scale aScl , LSM9DS0_mag_scale mScl ,
				LSM9DS0Gyro_odr gODR , LSM9DS0_accel_odr aODR, 
				LSM9DS0_mag_odr mODR );
	...
	void LSM9DS0_configGyroInt(uint8 int1Cfg, uint16 int1ThsX ,
						  uint16 int1ThsY , uint16 int1ThsZ , 
						  uint8 duration );


        void LSM9DS0_calLSM9DS0(float gbias[3], float abias[3]);
	...
	// Input:
	// 	- subAddress = Register to be read from.
	// 	- * dest = A pointer to an array of uint8's. Values read will be
	...
	void LSM9DS0_SPIreadBytes(uint32 slave, uint8 subAddress, uint8 * dest, uint8 count);
